...
<Image src="/assets/running_your_project_1.png" alt="A gazelle project while executing" />
...
`backend/server/lib/routes/hello_gazelle_route/handlers/hello_gazelle_get_handler.dart`
...
<Image src="/assets/running_your_project_2.png" alt="Updated Gazelle response" />
